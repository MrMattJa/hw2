...
function checkAnswer2(answer) {
    ...
    if (answer === 'all'){
        result2.textContent = "ถูกต้องแล้วฮ๊าฟ!!";
        result2.style.color = 'green';
    } else {
        result2.textContent = "เอ๊ะ น่าจะอยู่มากกว่านั้นนะ";
...
function checkTotal(){
    ...
    if (check1.textContent == "ถูกต้อง PIM ย่อมาจาก PIM" && check2.textContent == "ถูกต้องแล้วฮ๊าฟ!!") {
    ...
    } else if(check1.textContent == "ถูกต้อง PIM ย่อมาจาก PIM" || check2.textContent == "ถูกต้องแล้วฮ๊าฟ!!") {
